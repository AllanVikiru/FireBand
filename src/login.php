    ...
    <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
        ...
        <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
            <div class="content content-full">
                ...
                <form class="js-validation-login px-30" action="firefighter.php" method="post">
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-sm btn-hero btn-alt-primary" id="login">
                            <i class="si si-login mr-10"></i> Sign In
                        </button>
                        <div class="mt-30">
                            <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="register.php">
                                <i class="fa fa-user-plus mr-5"></i> Create Account
                            </a>

...
$cb->title                      = 'FireBand Web App';
$cb->description                = '';
$cb->template_author            = 'pixelcave';
$cb->template_name              = 'Codebase';
$cb->template_version           = '3.2';
$cb->logo                       = '<span class="font-size-xl text-dual-primary-dark">fire</span><i class="si si-fire text-primary"></i><span class="font-size-xl text-dual-primary-dark">band</span>';

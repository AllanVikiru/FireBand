...
<html lang="en" class="no-focus">
    <head>
        ...
        <link rel="icon" href="<?php echo $cb->assets_folder; ?>/media/favicons/favicon.png">
        <link rel="apple-touch-icon" sizes="180x180" href="<?php echo $cb->assets_folder; ?>/media/favicons/favicon.png">
        <!-- END Icons -->
